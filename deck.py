...
class Deck:
    ...
    # TODO: Adopt convention from (https://peps.python.org/pep-0008/) of members that are intended to be non-public starting with a single '_'
    # Do this throughout the code base
    def __init__(self, isInfinite = False):
        ...
        self._deck=[]
        self._deck.append(Card('S','A'))
        self._deck.append(Card('S','2'))
        self._deck.append(Card('S','3'))
        self._deck.append(Card('S','4'))
        self._deck.append(Card('S','5'))
        self._deck.append(Card('S','6'))
        self._deck.append(Card('S','7'))
        self._deck.append(Card('S','8'))
        self._deck.append(Card('S','9'))
        self._deck.append(Card('S','10'))
        self._deck.append(Card('S','J'))
        self._deck.append(Card('S','Q'))
        self._deck.append(Card('S','K'))
        self._deck.append(Card('C','A'))
        self._deck.append(Card('C','2'))
        self._deck.append(Card('C','3'))
        self._deck.append(Card('C','4'))
        self._deck.append(Card('C','5'))
        self._deck.append(Card('C','6'))
        self._deck.append(Card('C','7'))
        self._deck.append(Card('C','8'))
        self._deck.append(Card('C','9'))
        self._deck.append(Card('C','10'))
        self._deck.append(Card('C','J'))
        self._deck.append(Card('C','Q'))
        self._deck.append(Card('C','K'))       
        self._deck.append(Card('H','A'))
        self._deck.append(Card('H','2'))
        self._deck.append(Card('H','3'))
        self._deck.append(Card('H','4'))
        self._deck.append(Card('H','5'))
        self._deck.append(Card('H','6'))
        self._deck.append(Card('H','7'))
        self._deck.append(Card('H','8'))
        self._deck.append(Card('H','9'))
        self._deck.append(Card('H','10'))
        self._deck.append(Card('H','J'))
        self._deck.append(Card('H','Q'))
        self._deck.append(Card('H','K'))
        self._deck.append(Card('D','A'))
        self._deck.append(Card('D','2'))
        self._deck.append(Card('D','3'))
        self._deck.append(Card('D','4'))
        self._deck.append(Card('D','5'))
        self._deck.append(Card('D','6'))
        self._deck.append(Card('D','7'))
        self._deck.append(Card('D','8'))
        self._deck.append(Card('D','9'))
        self._deck.append(Card('D','10'))
        self._deck.append(Card('D','J'))
        self._deck.append(Card('D','Q'))
        self._deck.append(Card('D','K'))
